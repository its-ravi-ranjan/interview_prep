...
public class Factorial {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Factorial of 5: " + fact(5));  // Expected: 120
        
        // Test case 2: Factorial of 1
        System.out.println("Factorial of 1: " + fact(1));  // Expected: 1
        
        // Test case 3: Factorial of 0 (edge case)
        System.out.println("Factorial of 0: " + fact(0));  // Expected: 1 (mathematical definition)
        
        // Test case 4: Factorial of 10
        System.out.println("Factorial of 10: " + fact(10));  // Expected: 3628800
        ...
        */
        ...
        // Note: For larger numbers, we should use BigInteger to avoid overflow
        // This implementation uses long to handle factorials up to 20
    }
} 