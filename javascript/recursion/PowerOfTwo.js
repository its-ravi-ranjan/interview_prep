...
function testPowerOfTwo() {
    ...
    console.log("Is 8 a power of 2?", isPowerOfTwo(8));  // Expected: true
    
    // Test case 2: Not a power of 2
    console.log("Is 18 a power of 2?", isPowerOfTwo(18));  // Expected: false
    
    // Test case 3: Edge case - 1
    console.log("Is 1 a power of 2?", isPowerOfTwo(1));  // Expected: true
    
    // Test case 4: Edge case - 0
    console.log("Is 0 a power of 2?", isPowerOfTwo(0));  // Expected: false
    
    // Test case 5: Edge case - negative number
    console.log("Is -4 a power of 2?", isPowerOfTwo(-4));  // Expected: false
    
    // Test case 6: Large power of 2
    console.log("Is 1024 a power of 2?", isPowerOfTwo(1024));  // Expected: true
