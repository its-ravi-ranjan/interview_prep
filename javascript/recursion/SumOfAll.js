 ...
 * @param {number} n - The index up to which sum is to be calculated
 * @return {number} The sum of array elements from index 0 to n
 */
function sum(arr, n) {
...
function testSum() {
    ...
    console.log("Sum of array [5, 2, 6, 1, 3]:", sum(arr1, arr1.length - 1));  // Expected: 17
    
    // Test case 2: Single element array
    const arr2 = [7];
    console.log("Sum of array [7]:", sum(arr2, arr2.length - 1));  // Expected: 7
    
    // Test case 3: Array with negative numbers
    const arr3 = [-1, 2, -3, 4];
    console.log("Sum of array [-1, 2, -3, 4]:", sum(arr3, arr3.length - 1));  // Expected: 2
    
    // Test case 4: Array with zeros
    const arr4 = [0, 0, 0, 0];
    console.log("Sum of array [0, 0, 0, 0]:", sum(arr4, arr4.length - 1));  // Expected: 0
