 ...
 * @param {number} n - The number up to which sum is to be calculated
 * @return {number} The sum of first n natural numbers
 */
function sum(n) {
...
function testSum() {
    ...
    console.log("Sum of first 5 natural numbers:", sum(5));  // Expected: 15
    
    // Test case 2: Sum of first 1 natural number
    console.log("Sum of first 1 natural number:", sum(1));  // Expected: 1
    
    // Test case 3: Sum of first 0 natural numbers
    console.log("Sum of first 0 natural numbers:", sum(0));  // Expected: 0
    
    // Test case 4: Sum of first 10 natural numbers
    console.log("Sum of first 10 natural numbers:", sum(10));  // Expected: 55
